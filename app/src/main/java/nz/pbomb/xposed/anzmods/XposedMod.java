...
public class XposedMod implements IXposedHookZygoteInit, IXposedHookLoadPackage {
    ...
    public void hookAnzGoMoneyApplication(final XC_LoadPackage.LoadPackageParam lpparam) {
         ...
         */
        //  - v5.4.2 and previous - Class: xxxxxx.jejeee | Method: isRooted
        ...
        //  - v5.4.2 and previous - Class: xxxxxx.jejeee | Method: isRootedQuickCheck
        ...
        //  - v5.4.2 and previous - Class: xxxxxx.jejeee | Method: isDebug
        ...
        findAndHookMethod("nz.co.anz.android.mobilebanking.b.bp", lpparam.classLoader, "p", new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                //refreshSharedPreferences();
                if(sharedPreferences.getBoolean(PREFERENCES.KEYS.ANZ.ROOT_DETECTION, PREFERENCES.DEFAULT_VALUES.ANZ.ROOT_DETECTION)) {
